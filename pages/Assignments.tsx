...
const Assignments: React.FC = () => {
  ...
  const handleOpenEdit = (a: Assignment) => {
    ...
    setFormData({
      ...
      requiredFormats: a.requiredFormats.join(', '),
      status: a.status,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const payload: Assignment = {
      ...
      review1Date: formData.review1Date,
      progress1: formData.progress1,
      observation1: formData.observation1,
      review2Date: formData.review2Date,
      progress2: formData.progress2,
